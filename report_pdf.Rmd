...
lrtest(best_model) # erarbeitetes Modell ist besser als Nullmodell?
```

Mithilfe eines Likelihood-Ratio Tests wird überprüft welches Modell das bessere ist.
```{r Vergleich der Modelle, echo=FALSE}

# lrtest(best_model, model) # restringiertes Modell und optimiertes Modell mit mehr IA-Termen
