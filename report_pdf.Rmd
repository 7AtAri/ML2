...
plot(svm_best_model, scaledRISK_train, col = svm_best_model_pred)


library(ggplot2)

# Assuming 'test_data' contains your test features and 'svm_pred' are the predictions
ggplot() +
  geom_point(data = test_data, aes(x = feature1, y = feature2, color = svm_pred)) +
  # Add additional layers for decision boundaries, support vectors, etc.
```
