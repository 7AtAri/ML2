...
RISK_imp_s <- RISK_imp_num %>% 
  mutate(suicidal_class = ifelse(q29 > 1,   3,
                          ifelse(q28 > 1,   3,
                          ifelse(q27 == 1,  3,
                          ifelse(q26 == 1,  2,
                          ifelse(q25 == 1,  2,
...
RISK_imp_s[, c("q25", "q26", "q27", "q28", "q29")] <- NULL  # removing the columns related to the target variable
```
...
strat_df<-RISK_imp_s[, "suicidal_class"]
...
RISK_2000 <- getdata(RISK_imp_s, sample_obj)
