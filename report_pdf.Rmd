...
RISK_imp_s5$suicidal_class<-factor(RISK_imp_s5$suicidal_class, ordered = TRUE)  # factorize the target variable
```
...
```{r}
describe(RISK_2000_5)
str(RISK_2000_5$suicidal_class)
```
...
# str(RISK) # 
useless_cols<-c("ID_unit", "Prob" )  # add all the columns we do not need
